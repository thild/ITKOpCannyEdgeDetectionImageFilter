/*=========================================================================
  ...
  Module:    $RCSfile: itkOpGaussianOperator.h,v $
  Language:  C++
...
=========================================================================*/
#ifndef __itkOpGaussianOperator_h
#define __itkOpGaussianOperator_h
 ...
 *
 * OpGaussianOperator takes two parameters:
...
class ITK_EXPORT OpGaussianOperator
  : public NeighborhoodOperator<TPixel, VDimension, TAllocator>
{
public:
  /** Standard class typedefs. */
  typedef OpGaussianOperator                                        Self;
  typedef NeighborhoodOperator<TPixel, VDimension, TAllocator>    Superclass;
  typedef typename Superclass::CoefficientVector CoefficientVector;

  /** Constructor. */
  OpGaussianOperator() : m_Variance(1), m_MaximumError(.01), m_MaximumKernelWidth(30) { }

  /** Copy constructor */
  OpGaussianOperator(const Self &other)
  ...
  CoefficientVector GetCoefficients() { return GenerateCoefficients();}

  /** Prints some debugging information. */
  virtual void PrintSelf(std::ostream &os, Indent i) const
  {
    os << i << "OpGaussianOperator { this=" << this
...
#define ITK_TEMPLATE_OpGaussianOperator(_, EXPORT, x, y) namespace itk { \
  _(2(class EXPORT OpGaussianOperator< ITK_TEMPLATE_2 x >)) \
  namespace Templates { typedef OpGaussianOperator< ITK_TEMPLATE_2 x > \
                                                  OpGaussianOperator##y; } \
  }

#if ITK_TEMPLATE_EXPLICIT
# include "Templates/itkOpGaussianOperator+-.h"
#endif

#if ITK_TEMPLATE_TXX
# include "itkOpGaussianOperator.txx"
#endif
